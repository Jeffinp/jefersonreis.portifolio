        ...
        <section id="resume" className="relative py-20 bg-white dark:bg-slate-900">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            {t("resume.highlightItems", { returnObjects: true }).map(
                                (item, index) => (
                                    <div
                                        key={index}
                                        className="flex items-center bg-gradient-to-r from-blue-500/10 to-purple-500/10 p-3 rounded-lg"
                                    >
                    ...
                    <div
                        className={`space-y-8 transition-all duration-300 ${expanded ? "block" : "hidden"
                            }`}
                    >
                        <Card>
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                {t("resume.softSkills.items", { returnObjects: true }).map(
                                    (skill, index) => (
                                        <div
                                            key={index}
                                            className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 p-3 rounded-lg"
                                        >
                                            <span className="text-gray-700 dark:text-gray-300">
                                                {skill}
                                            </span>
