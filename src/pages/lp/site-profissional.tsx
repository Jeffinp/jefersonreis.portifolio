...
export default function SiteProfissionalLandingPage() {
  ...
  const whatsappNumber =
    process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || '+55 71 8174-7099'
  ...
  return (
    <>
      <Head>
        <title>
          Site Profissional para sua Empresa | Desenvolvedor Full-Stack
        </title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="Site Profissional para sua Empresa"
        />
        <meta
          property="og:description"
          content="Design moderno, SEO otimizado, mobile-first. Orçamento grátis em 24h."
        />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="/og-site-profissional.jpg" />
        <link
          rel="canonical"
          href="https://jefersonreis.dev/lp/site-profissional"
        />
      </Head>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            >
              ...
              <div className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 backdrop-blur-sm">
                ...
                <span className="text-sm font-medium">
                  +50 Sites Criados • 98% Satisfação
                </span>
              </div>

              {/* Headline */}
              <div>
                <h1 className="mb-4 text-4xl leading-tight font-bold tracking-tight sm:text-5xl lg:text-6xl">
                  Site Profissional que{' '}
                  <span className="text-yellow-400">Vende 24h</span> por Dia
                </h1>
                <p className="text-xl text-blue-100 lg:text-2xl">
                  Aumente suas vendas com um site moderno, rápido e otimizado
                  para Google
                </p>
              </div>
            ...
            >
              <div className="relative rounded-2xl bg-white/10 p-8 backdrop-blur-md">
                ...
                <div className="absolute -top-4 -right-4 rounded-lg bg-white p-4 shadow-xl">
              ...
              {[
                {
                  ...
                  testimonial:
                    'Meu faturamento triplicou em 3 meses após o novo site!',
                },
                {
                  name: 'João Santos',
                ...
                },
                {
                  ...
                  result: '+320% leads',
                  testimonial:
                    'O site profissional mudou completamente meu negócio.',
                },
            ...
            {[
              {
                ...
                answer:
                  'Entre 10 a 15 dias úteis após aprovação do layout. Sites mais complexos podem levar até 20 dias.',
              },
              {
                question: 'Preciso pagar tudo à vista?',
                answer:
                  'Não! Trabalho com 50% de entrada e 50% na entrega. Aceito Pix, cartão e boleto.',
              },
              {
                question: 'O site vai aparecer no Google?',
                answer:
                  'Sim! Todos os sites são otimizados para SEO. Você começará a aparecer nas buscas em 30-60 dias.',
              },
              {
                question: 'Consigo atualizar o conteúdo sozinho?',
                answer:
                  'Sim! Você terá um painel administrativo completo e intuitivo. Também ofereço treinamento gratuito.',
              },
              {
                question: 'E se eu não gostar do resultado?',
                answer:
                  'Ofereço revisões ilimitadas até sua total satisfação. Seu site só é entregue quando você aprovar 100%.',
              },
            ].map((faq, index) => (
              <motion.div
                key={index}
      ...
      <section className="bg-gradient-to-r from-blue-600 to-purple-600 px-4 py-16 text-white sm:px-6 lg:px-8 lg:py-24">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mb-8 text-xl opacity-90">
            Solicite seu orçamento agora e receba uma proposta personalizada em
            até 24 horas
          </p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          ...
          >
            <button
              ...
              className="absolute top-4 right-4 rounded-lg p-2 hover:bg-gray-100 dark:hover:bg-gray-700"
            >
              ✕
            </button>
            <LeadQualifierForm />
