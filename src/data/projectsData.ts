...
export const projects: Project[] = [
  ...
  // COMMERCIAL PROJECTS (Listed first)
  {
    ...
    testimonial: {
      text: 'O desenvolvimento deste SaaS foi excepcional, resultando em um produto otimizado e bem estruturado. Continuo refinando minhas ideias e aprimorando a plataforma, e sou profundamente grato ao Jeferson pelo apoio contínuo e colaboração neste projeto.',
      author: 'Pedro',
      role: 'Empresário',
      company: 'Empresario',
    },
