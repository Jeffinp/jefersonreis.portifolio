...
const Footer = () => {
    const socialLinks = [
        {
            icon: <Linkedin className="transition-all duration-300 group-hover:text-blue-500 dark:group-hover:text-blue-400" />,
            href: "https://www.linkedin.com/in/jeferson-reis-877a942b7/",
            title: "LinkedIn de Jeferson Reis Almeida",
            label: "LinkedIn"
        },
        {
            icon: <Github className="transition-all duration-300 group-hover:text-gray-900 dark:group-hover:text-gray-100" />,
            href: "https://github.com/Jeffinp",
            title: "GitHub de Jeferson Reis Almeida",
            label: "GitHub"
        },
        {
            icon: <Instagram className="transition-all duration-300 group-hover:text-pink-600 dark:group-hover:text-pink-400" />,
            href: "https://www.instagram.com/jeffinx___/",
            title: "Instagram de Jeferson Reis Almeida",
            label: "Instagram"
        },
        {
            icon: <MessageCircle className="transition-all duration-300 group-hover:text-green-600 dark:group-hover:text-green-400" />,
