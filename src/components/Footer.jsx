...
const Footer = () => {
    ...
    const socialLinks = [
        ...
        },
        {
            icon: (
                <Github
                    className="transition-all duration-300 group-hover:text-gray-900 dark:group-hover:text-gray-100"
                    aria-label="GitHub"
                />
            ),
        ...
        },
        {
            icon: (
                <Instagram
                    className="transition-all duration-300 group-hover:text-pink-600 dark:group-hover:text-pink-400"
        ...
        },
        {
            icon: (
                <MessageCircle
                    className="transition-all duration-300 group-hover:text-green-600 dark:group-hover:text-green-400"
                    aria-label="WhatsApp"
                />
            ),
        ...
        },
        {
            icon: (
                <FaDiscord
                    className="transition-all duration-300 group-hover:text-blue-600 dark:group-hover:text-blue-400 w-6 h-6"
                    aria-label="Discord"
                />
            ),
