    ...
    <>
      <motion.header
        ...
        className={`fixed top-0 left-0 right-0 z-30 transition-all duration-300 ${
          isScrolled
            ? quantumMode
              ? 'bg-cosmic-black/80 backdrop-blur-xl border-b border-stellar-blue/20'
          ...
          <div className="flex h-16 items-center justify-between">
            ...
            <Link href="/" className="flex items-center gap-3">
              <motion.div
                ...
                transition={{ duration: 20, repeat: quantumMode ? Infinity : 0, ease: 'linear' }}
                className="relative h-10 w-10"
              >
                {/* Quantum Logo */}
                <div className={`absolute inset-0 rounded-lg ${
                  quantumMode 
                    ? 'bg-gradient-to-br from-stellar-blue via-nebula-purple to-nova-pink' 
                ...
                {quantumMode && (
                  <div className="absolute -inset-1 rounded-lg bg-gradient-to-br from-stellar-blue via-nebula-purple to-nova-pink opacity-50 blur-md" />
                )}
              </motion.div>
              ...
              <div>
                ...
                <p className={`text-xs ${
                  quantumMode ? 'text-stellar-blue' : 'text-gray-500 dark:text-gray-400'
                }`}>
            ...
            <nav className="hidden md:flex items-center gap-6">
              ...
              <div className="flex items-center gap-4">
                <a
                  ...
                  className={`text-sm font-medium transition-colors hover:text-stellar-blue ${
                    quantumMode ? 'text-gray-300' : 'text-gray-700 dark:text-gray-300'
                  }`}
                >
                  {t('nav.about')}
                </a>
              ...
              <div className={`h-6 w-px ${
                quantumMode ? 'bg-stellar-blue/30' : 'bg-gray-300 dark:bg-gray-600'
              }`} />
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <kbd className={`ml-1 rounded px-1.5 py-0.5 text-xs ${
                      quantumMode 
                  ...
                  {quantumMode && (
                    <div className="absolute -inset-1 rounded-lg bg-stellar-blue/20 opacity-0 blur-md transition-opacity group-hover:opacity-100" />
                  )}
                </motion.button>
                ...
                <motion.button
                  ...
                  title={quantumMode ? 'Disable Quantum Mode' : 'Enable Quantum Mode'}
                >
                  {quantumMode ? (
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className={`fixed top-16 left-0 right-0 z-20 border-b p-4 md:hidden ${
              quantumMode
                ? 'bg-cosmic-black/95 border-stellar-blue/20 backdrop-blur-xl'
                : 'bg-white/95 dark:bg-gray-900/95 border-gray-200 dark:border-gray-700 backdrop-blur-xl'
            }`}
          >
            <nav className="space-y-4">
              ...
              <div className={`my-4 h-px ${
                quantumMode ? 'bg-stellar-blue/30' : 'bg-gray-200 dark:bg-gray-700'
              }`} />
        ...
        {showSettings && (
          <motion.div
            ...
            className={`fixed top-20 right-4 z-40 w-80 rounded-xl p-4 shadow-2xl ${
              quantumMode
                ? 'bg-cosmic-black/90 border border-stellar-blue/30 backdrop-blur-xl'
            ...
            <div className="space-y-3">
              <label className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative h-6 w-11 rounded-full transition-colors ${
                    quantumMode ? 'bg-stellar-blue' : 'bg-gray-300 dark:bg-gray-600'
                  }`}
                >
              ...
              <label className="flex items-center justify-between">
                ...
                <button
                  onClick={onSoundToggle}
                  className={`relative h-6 w-11 rounded-full transition-colors ${
                    soundEnabled ? 'bg-stellar-blue' : 'bg-gray-300 dark:bg-gray-600'
                  }`}
                >
                  <div className={`absolute top-0.5 h-5 w-5 rounded-full bg-white transition-transform ${
