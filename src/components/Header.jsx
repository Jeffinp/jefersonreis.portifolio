...
const LanguageButton = ({
  ...
  return (
    <button
      ...
      className={`relative group p-1 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 rounded-full overflow-hidden ${
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div
          ref={mobileMenuRef}
          className={`absolute inset-x-0 top-16 md:hidden bg-white dark:bg-gray-900 shadow-lg z-50 overflow-hidden transition-all duration-300 ${
            menuOpen
