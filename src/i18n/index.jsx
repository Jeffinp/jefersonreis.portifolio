    ...
    translation: {
      ...
      about: {
        ...
        paragraphs: {
          ...
          second:
            "Tenho experiência em React e Node.js, com foco em performance e experiência do usuário (UX/UI). Além disso, sou especializado em design gráfico, criando identidades visuais únicas e materiais gráficos personalizados.",
        },
        cta: {
        ...
        cards: {
          webDev: {
            ...
            description:
              "Criação de sites responsivos e otimizados para SEO, com foco em performance e design atraente.",
            ariaLabel: "Saiba mais sobre Desenvolvimento Web",
          },
          design: {
            title: "Design Gráfico",
            description:
              "Criação de identidades visuais, logotipos e materiais gráficos personalizados.",
            ariaLabel: "Saiba mais sobre Design Gráfico",
          },
          backend: {
            title: "Desenvolvimento Backend",
            description:
              "Desenvolvimento de APIs robustas e soluções escaláveis para diferentes tipos de aplicações.",
            ariaLabel: "Saiba mais sobre Desenvolvimento Backend",
          },
          softSkills: {
            title: "Habilidades Interpessoais",
            description:
              "Comunicação eficaz, trabalho em equipe e resolução criativa de problemas.",
      ...
      portfolio: {
        ...
        projectLabels: {
          ...
          restrictedMessage:
            "Este projeto foi desenvolvido sob contrato comercial. Por questões de confidencialidade, o acesso ao projeto completo não está disponível publicamente.",
        },
        projects: {
          meuShop: {
            title: "Meu Shop - Plataforma de E-commerce",
            description:
              "Atualmente, estou desenvolvendo uma plataforma de e-commerce com Angular, TypeScript e Tailwind CSS 4.0, focando em design responsivo, animações fluidas e acessibilidade. O site contará com SPA, formulário de orçamento, carrossel 3D, hero com vídeo, e páginas institucionais. O backend ainda será implementado, com planos para utilizar Python para processar formulários com validação, segurança e envio de e-mails. O projeto incluirá SEO avançado, integração com WhatsApp, otimização de performance e animações contextuais. Está em fase beta.",
          },
          itamir: {
          ...
          flyserv: {
            ...
            description:
              "Desenvolvi a plataforma web da FlyServ Drones com React 19, TypeScript e Tailwind CSS 4.0, focando em design responsivo, animações fluidas e acessibilidade. O site conta com SPA, formulário de orçamento, carrossel 3D, hero com vídeo, e páginas institucionais. No backend, utilizei PHP para processar formulários com validação, segurança e envio de e-mails. O projeto inclui SEO avançado, integração com WhatsApp, otimização de performance e animações contextuais.",
          },
          gestaoFinanceira: {
      ...
      skills: {
        ...
        description:
          "Conheça minhas principais habilidades técnicas e comportamentais desenvolvidas ao longo da carreira.",
      ...
      ebooksPromo: {
        ...
        description:
          "Acesse minha biblioteca exclusiva de eBooks com conteúdos sobre tecnologia, empreendedorismo e desenvolvimento pessoal. Material prático e objetivo para aplicação imediata.",
        benefits: {
      ...
      ebooks: {
        ...
        description:
          "Confira nossos ebooks exclusivos sobre tecnologia, carreira e desenvolvimento pessoal.",
        ...
        featuredEbooks: {
          0: {
            ...
            description:
              "Um guia completo para quem está começando no desenvolvimento web. Aprenda HTML, CSS e JavaScript de forma prática e objetiva.",
          },
          1: {
            title:
              "Internet Lucrativa: O Guia Definitivo para ganhar dinheiro online",
            description:
              "Descubra estratégias comprovadas para monetizar seu negócio online. Este guia abrangente ensina desde a escolha do nicho até técnicas avançadas de monetização e marketing digital.",
          },
          2: {
            title: "Carreira Freelancer em Tecnologia",
            description:
              "Descubra como iniciar e desenvolver uma carreira de sucesso como freelancer na área de tecnologia e design.",
          },
          3: {
            title: "Guia Prático de Inteligência Artificial",
            description:
              "Entenda os conceitos fundamentais de IA e como aplicá-los em projetos reais sem precisar ser um especialista.",
          },
          4: {
            title: "Dominando React",
            description:
              "Um guia avançado para desenvolvedores que querem aprimorar suas habilidades em React e criar aplicações modernas.",
          },
          5: {
            title: "Fundamentos de UX Design",
            description:
              "Aprenda os princípios essenciais de experiência do usuário para criar produtos digitais que encantam.",
          },
        },
      },
    },
    ...
    translation: {
      ...
      about: {
        ...
        paragraphs: {
          ...
          second:
            "I have experience with React and Node.js, focusing on performance and user experience (UX/UI). Additionally, I specialize in graphic design, creating unique visual identities and custom graphic materials.",
        },
        cta: {
          contact: "Get in Touch",
        ...
        services: {
          title: "My Services",
          subtitle:
            "Discover how I can help transform your ideas into reality.",
        },
        cards: {
          webDev: {
            title: "Web Development",
            description:
              "Creation of responsive and SEO-optimized websites, focusing on performance and attractive design.",
            ariaLabel: "Learn more about Web Development",
          },
          design: {
            title: "Graphic Design",
            description:
              "Creation of visual identities, logos, and custom graphic materials.",
            ariaLabel: "Learn more about Graphic Design",
          },
          backend: {
            title: "Backend Development",
            description:
              "Development of robust APIs and scalable solutions for different types of applications.",
            ariaLabel: "Learn more about Backend Development",
          },
          softSkills: {
            title: "Interpersonal Skills",
            description:
              "Effective communication, teamwork, and creative problem solving.",
      ...
      services: {
        title: "My Services",
        subtitle: "Custom professional solutions to bring your ideas to life!",
        items: {
          web: {
            title: "Immersive Web Development",
            description:
        ...
        downloadDescription: "Discover all details and pricing in my catalog!",
        learnMore: "Learn more",
      ...
      timeline: {
        title: "My Journey",
        subtitle:
          "A journey through my professional evolution and achievements over the years.",
        showMore: "Show More",
        showLess: "Show Less",
        events: {
          0: {
            title: "Beginning of Development Career",
            subtitle: "Freelance Developer",
            date: "2018",
            description:
              "I began my journey as a web developer, working on freelance projects and developing my skills in HTML, CSS, and JavaScript.",
          },
          1: {
            ...
            date: "2019",
            description:
              "I deepened my knowledge in React.js, Next.js, and other modern front-end technologies, expanding my ability to create interactive interfaces.",
          },
          2: {
            title: "Full Stack Development",
            subtitle: "Back-end & Databases",
            date: "2020-2021",
            description:
              "I expanded my horizons to full stack development, working with Node.js, Express, MongoDB, and MySQL to create complete web applications.",
          },
          3: {
            ...
            date: "2022",
            description:
              "I began sharing my knowledge through tutorials, technical articles, and small online courses, helping other developers grow.",
          },
          4: {
            ...
            date: "2023-Present",
            description:
              "I currently focus on developing technological solutions for companies, including management systems, dashboards, and custom web applications.",
          },
        },
      },
      portfolio: {
      ...
      skills: {
        ...
        description:
          "Discover my key technical and interpersonal skills developed throughout my career.",
      ...
      ebooksPromo: {
        ...
        description:
          "Access my exclusive library of eBooks with content on technology, entrepreneurship, and personal development. Practical and objective material for immediate application.",
        benefits: {
          0: "Exclusive content",
        ...
        warningMessage:
          "New eBooks will be available soon. In the meantime, enjoy the ones already available.",
      },
      ebooks: {
        title: "Featured Ebooks",
        description:
          "Check out our exclusive ebooks on technology, career, and personal development.",
        ...
        featuredEbooks: {
          ...
          2: {
            ...
            description:
              "Discover how to start and develop a successful career as a freelancer in technology and design.",
          },
          3: {
            title: "Practical Guide to Artificial Intelligence",
            description:
              "Understand the fundamental concepts of AI and how to apply them in real projects without needing to be an expert.",
          },
          4: {
            title: "Mastering React",
            description:
              "An advanced guide for developers who want to improve their React skills and create modern applications.",
          },
          5: {
            title: "UX Design Fundamentals",
            description:
              "Learn the essential principles of user experience to create digital products that delight.",
          },
        },
      },
    },
